...
@section('content')
    <div class="container">
        ...
        <p>
            Desarrollar el objeto social de {!! config('constants.companyInfo.longName') !!}, conforme a sus estatutos sociales, incluidas las gestiones propias de: Clientes, proveedores, talento humano, servicio al cliente, tecnologías de la información.            
        </p>
        <p>
