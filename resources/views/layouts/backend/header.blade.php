            ...
            <li class="profile dropdown">
                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                    @if (is_null(auth()->user()->picture))
                        <div class="img" style="{{ 'background-image: url('.env("APP_URL").config('constants.usersImages').'default.png)' }}">
                        </div>
                    @else
                        <div class="img" style="{{ 'background-image: url('.env("APP_URL").config('constants.usersImages').auth()->user()->picture.')' }}">
                        </div>
                    @endif
                    {{--
